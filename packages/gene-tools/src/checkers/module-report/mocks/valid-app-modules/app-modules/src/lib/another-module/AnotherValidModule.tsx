...
function RawAnotherValidModule() {
  const {
    ref,
    someProps,
    useSomeMediators,
...
const {declarations, module: AnotherValidModule} = createGeneModule({
  module: RawAnotherValidModule,
  declarations: {
...
export {AnotherValidModule, declarations};
